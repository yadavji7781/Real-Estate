...
<body>
    ...
    <section class="properties">
        <div class="containers">
            <h2 class="sections-title">Elegant Apartment</h2>
            <div class="propertie-grid">

                <!-- Property: Modern Bunglow -->
                <div class="detail-property-card">
                    ...
                    <div class="property-info">
                        ...
                        <a href="/real-e/house-hunts(html)/buy.php?name=Elegant%20Apartment&price=3200000" class="btn btn-secondary">Buy</a>
                    </div>
                </div>
    </section>
