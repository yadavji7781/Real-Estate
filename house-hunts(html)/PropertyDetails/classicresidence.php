...
<body>
    ...
    <section class="properties">
        <div class="container">
            <h2 class="section-title">Classic Residence</h2>
            <div class="properties-grid">
                ...
                <div class="detail-property-card">
                    ...
                    <div class="property-info">
                        ...
                        <a href="/real-e/house-hunts(html)/buy.php?name=Classic%20Residence&price=2200000" class="btn btn-secondary">Buy</a>
                    </div>
                </div>
    </section>
